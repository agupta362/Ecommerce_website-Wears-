...
const ReturnPolicy = () => {
  const { returnPolicy } = siteConfig.legal;
      ...
      <main className="flex-1">
        <section className="bg-secondary py-12">
          <div className="container-tight">
            <PageBreadcrumbs 
              items={[{ label: 'Return & Refund Policy' }]} 
            ...
            />
            <h1 className="section-title text-secondary-foreground">Return & Refund Policy</h1>
          </div>
        </section>
        <section className="container-tight px-4 sm:px-6 lg:px-8 py-8 sm:py-16 prose prose-lg max-w-3xl mx-auto">
          {returnPolicy.sections.map((s) => (
            <div key={s.heading}>
              <h2>{s.heading}</h2>
